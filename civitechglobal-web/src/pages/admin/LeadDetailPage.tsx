        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
          ...
          <div>
            ...
            <p className="font-medium text-text-primary">
              {contactTimeLabels[lead.preferredContactTime] ||
          ...
          <div>
            ...
            <p className="font-medium text-text-primary">
              {lead.category?.emoji ? `${lead.category.emoji} ` : ""}
              {lead.category?.title}
            </p>
          </div>
          <div>
      ...
      <Card>
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          <Select
            value={lead.status}
            onChange={(e) =>
              updateStatus.mutate(e.target.value as Lead["status"])
            }
            options={statusOptions}
            className="sm:w-64"
          />
          <Button
            onClick={() => updateStatus.mutate(lead.status)}
