...
export default function ServiceFormPage() {
  ...
  return (
    <div>
      ...
      <h1 className="text-2xl font-bold text-dark-900 dark:text-white mb-6">{isEdit ? t.admin.serviceForm.editTitle : t.admin.serviceForm.createTitle}</h1>
      ...
      <Card className="max-w-2xl">
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <label className="flex items-center gap-2 text-sm">
            ...
            <span className="text-dark-700 dark:text-dark-300">{t.admin.serviceForm.isActive}</span>
          </label>
