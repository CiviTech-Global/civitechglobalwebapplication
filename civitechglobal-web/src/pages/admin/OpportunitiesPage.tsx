  ...
  const columns = [
    ...
    { key: 'actions', header: '', className: 'w-24', render: (i: any) => (
      <div className="flex items-center gap-2">
        <Link to={`/admin/opportunities/${i.id}/edit`} className="text-brand-green-600 hover:text-brand-green-700"><Edit className="w-4 h-4" /></Link>
  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-6">
        <h1 className="text-2xl font-bold text-text-primary">{t.admin.opportunities}</h1>
