...
export default function AdminLeads() {
  ...
  const columns = [
    ...
    },
    {
      ...
      render: (l: Lead) => l.fullName,
    },
    {
      key: "phoneNumber",
      header: t.leads.phoneNumber,
      render: (l: Lead) => l.phoneNumber,
    },
    {
      key: "category",
      header: t.leads.category,
      render: (l: Lead) =>
        `${l.category?.emoji ? `${l.category.emoji} ` : ""}${l.category?.title || ""}`,
    },
    {
      key: "subcategory",
      header: t.leads.subcategory,
      render: (l: Lead) => l.subcategory?.title || "",
    },
    ...
    },
    {
      ...
      render: (l: Lead) => formatDate(l.createdAt),
    },
    {
      key: "actions",
      header: "",
