...
export default function ServicesPage() {
  ...
  const getServiceIcon = (serviceType?: string) => {
    switch (serviceType) {
      case "FREELANCERS_CENTER":
        return Users;
      case "INSURANCE_MARKETPLACE":
        return Shield;
      default:
        return Users;
    }
                ...
                <Link to={`/services/${service.slug}`}>
                  ...
                  >
                    <div className="flex items-start gap-4 mb-4">
                      <div className="w-14 h-14 shrink-0 bg-brand-green-600 rounded-xl flex items-center justify-center shadow-sm">
