      ...
      >
        ...
        <div>
          <div className="flex items-center gap-2 mb-3">
            ...
            {!product.isActive && (
              <Badge variant="warning">{t.products.comingSoon}</Badge>
            )}
          </div>
              ...
              <GlowCard hover={false} glowColor="purple">
                ...
                <div className="space-y-4">
                  <Input
                    ...
                    onChange={(e) =>
                      setDemoForm((p) => ({ ...p, email: e.target.value }))
                    }
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setDemoForm((p) => ({ ...p, subject: e.target.value }))
                    }
                  />
                  <TextArea
                    ...
                    onChange={(e) =>
                      setDemoForm((p) => ({ ...p, message: e.target.value }))
                    }
