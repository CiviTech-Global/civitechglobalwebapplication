...
export default function ServiceDetailPage() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <Link
        to="/services"
        className="inline-flex items-center gap-2 text-sm text-text-muted hover:text-brand-green-600 dark:hover:text-brand-green-400 mb-8"
      >
      ...
      >
        <div className="h-80 md:h-full bg-brand-green-600 rounded-2xl flex items-center justify-center shadow-sm">
        ...
        <div>
          ...
          <div className="flex items-center gap-4">
            {service.price && (
              <span className="text-3xl font-bold text-brand-green-600 dark:text-brand-green-400">
