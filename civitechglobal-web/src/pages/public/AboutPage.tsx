  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <motion.div className="text-center mb-16" {...fadeUp}>
        <h1 className="text-3xl md:text-4xl font-bold text-dark-900 dark:text-white mb-4">{t.about.title}</h1>
        <p className="text-dark-500 dark:text-dark-400 max-w-2xl mx-auto">{t.about.subtitle}</p>
      </motion.div>
        ...
        <motion.div {...fadeUp}>
          <Card className="h-full">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-xl font-bold text-dark-900 dark:text-white">{t.about.ourMission}</h2>
            </div>
        ...
        <motion.div {...fadeUp} transition={{ ...fadeUp.transition, delay: 0.1 }}>
          <Card className="h-full">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-xl font-bold text-dark-900 dark:text-white">{t.about.ourVision}</h2>
            </div>
            <p className="text-dark-500 dark:text-dark-400">
      ...
      <motion.div className="mb-16" {...fadeUp}>
        <h2 className="text-2xl font-bold text-dark-900 dark:text-white mb-4">{t.about.whoWeAre}</h2>
        <p className="text-dark-500 dark:text-dark-400 text-lg leading-relaxed">
          {content?.about_description || t.about.descriptionDefault}
        </p>
      </motion.div>

      <motion.div {...fadeUp}>
        <h2 className="text-2xl font-bold text-dark-900 dark:text-white mb-8 text-center">{t.about.values}</h2>
          ...
          {values.map((v, i) => (
            <motion.div key={v.title} {...fadeUp} transition={{ ...fadeUp.transition, delay: i * 0.1 }}>
              <Card hover className="text-center h-full">
                ...
                <h3 className="font-semibold text-dark-900 dark:text-white mb-2">{v.title}</h3>
                <p className="text-sm text-dark-500 dark:text-dark-400">{v.desc}</p>
              </Card>
            </motion.div>
          ))}
        </div>
