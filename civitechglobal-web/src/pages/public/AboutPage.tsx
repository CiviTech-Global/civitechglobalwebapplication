        ...
        <motion.div {...fadeUp}>
          <Card className="h-full">
            <div className="flex items-center gap-3 mb-4">
              <div className="w-10 h-10 bg-brand-green-600 rounded-lg flex items-center justify-center shadow-sm">
          ...
          {values.map((v, i) => (
            ...
            >
              <Card hover className="text-center h-full">
                <div className="w-12 h-12 bg-brand-green-600 rounded-lg flex items-center justify-center mx-auto mb-4 shadow-sm">
