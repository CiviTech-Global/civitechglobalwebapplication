export const fa = {
  ...
  home: {
    ...
    heroDescription:
      "ما راهکارهای نرم‌افزاری نوآورانه‌ای می‌سازیم که پل ارتباطی بین دولت‌ها، سازمان‌ها و مردم است.",
    exploreProducts: "مشاهده محصولات",
    viewServices: "خدمات ما",
    learnMore: "بیشتر بدانید",
    whatWeDo: "خدمات ما",
    whatWeDoDesc:
      "ما در ساخت راهکارهای فناوری تخصص داریم که مشارکت مدنی و ارائه خدمات عمومی را تقویت می‌کند.",
    ourProducts: "محصولات ما",
    ourProductsDesc:
      "مجموعه محصولات فناوری ما را برای توانمندسازی جوامع کشف کنید.",
    ourServices: "خدمات ما",
    ourServicesDesc: "خدمات حرفه‌ای فناوری متناسب با نیازهای شما.",
    joinTeam: "به تیم ما بپیوندید",
    joinTeamDesc:
      "ما به دنبال افراد با استعداد هستیم تا به مأموریت ما بپیوندند.",
    viewCareers: "مشاهده فرصت‌ها",
    getInTouch: "تماس با ما",
    getInTouchDesc:
      "سؤالی دارید یا می‌خواهید درباره پروژه‌ای صحبت کنید؟ خوشحال می‌شویم از شما بشنویم.",
    contactUs: "تماس با ما",
    readyToTransform: "آماده تحول در جامعه خود هستید؟",
    readyToTransformDesc:
      "با ما تماس بگیرید تا درباره راهکارهای فناوری مناسب سازمان شما گفتگو کنیم.",
    features: {
      civicEngagement: "مشارکت مدنی",
      civicEngagementDesc:
        "ساخت پلتفرم‌هایی که شهروندان را با دولت‌ها و جوامعشان متصل می‌کند.",
      secureSolutions: "راهکارهای امن",
      secureSolutionsDesc:
        "امنیت در سطح سازمانی با رمزنگاری سرتاسری و مطابقت با استانداردها.",
      fastScalable: "سریع و مقیاس‌پذیر",
      fastScalableDesc:
        "معماری مدرن طراحی شده برای رشد همراه با جوامع در حال گسترش.",
      communityDriven: "جامعه‌محور",
      communityDrivenDesc: "راهکارهایی طراحی شده با بازخورد و مشارکت جامعه.",
      customDev: "توسعه سفارشی",
      customDevDesc:
        "راهکارهای نرم‌افزاری اختصاصی برای نیازهای منحصر به فرد شما.",
  ...
  products: {
    title: "محصولات ما",
    description:
      "مجموعه محصولات فناوری ما را کشف کنید که برای توانمندسازی جوامع و سازمان‌ها طراحی شده‌اند.",
  ...
  services: {
    title: "خدمات ما",
    description:
      "خدمات حرفه‌ای فناوری برای کمک به رشد سازمان شما در عصر دیجیتال.",
    learnMore: "بیشتر بخوانید",
  ...
  careers: {
    title: "فرصت‌های شغلی",
    description:
      "به تیم ما بپیوندید و در ساخت راهکارهای فناوری مدنی مشارکت کنید.",
  ...
  about: {
    ...
    subtitle:
      "ما یک شرکت فناوری هستیم که به ساخت راهکارهای نرم‌افزاری برای توانمندسازی مشارکت مدنی اختصاص یافته‌ایم.",
    ourMission: "مأموریت ما",
    ourVision: "چشم‌انداز ما",
    whoWeAre: "ما کی هستیم",
    missionDefault:
      "مأموریت ما بهره‌گیری از فناوری برای ایجاد پلتفرم‌های مشارکت مدنی شفاف‌تر، کارآمدتر و قابل دسترس‌تر برای جوامع سراسر جهان است.",
    visionDefault:
      "جهانی که هر شهروند ابزار و پلتفرم لازم برای مشارکت فعال در شکل‌دهی جامعه و تصمیمات دولتی را دارد.",
    descriptionDefault:
      "رایان تمدن جهان گستر یک شرکت فناوری است که به ساخت راهکارهای نرم‌افزاری برای توانمندسازی مشارکت مدنی اختصاص یافته است.",
    values: "ارزش‌های ما",
    innovation: "نوآوری",
  ...
  contact: {
    title: "تماس با ما",
    description:
      "سؤالی دارید یا می‌خواهید با ما در ارتباط باشید؟ پیامی ارسال کنید و تیم ما به زودی پاسخ خواهد داد.",
    name: "نام",
  ...
  support: {
    title: "تماس با ما",
    description:
      "سؤال یا مشکلی دارید؟ یک تیکت پشتیبانی ارسال کنید و تیم ما به زودی پاسخ خواهد داد.",
    name: "نام",
    namePlaceholder: "نام شما",
    email: "ایمیل",
    emailPlaceholder: "email@example.com",
  ...
  admin: {
    ...
    adminForm: {
      ...
      generatedCredentials: "مدیر ایجاد شد",
      username: "نام کاربری",
      password: "رمز عبور",
      confirmPassword: "تأیید رمز عبور",
      passwordMismatch: "رمز عبور و تأیید آن یکسان نیستند",
      copyWarning:
        "رمز عبور واردشده تنظیم شد. لطفاً نام کاربری را با مدیر جدید به اشتراک بگذارید.",
    ...
    permissions: {
      title: "دسترسی‌ها",
      description:
        "مدیریت ماژول‌هایی که هر ادمین می‌تواند به آن‌ها دسترسی داشته باشد.",
    ...
    demoData: {
      ...
      description:
        "مدیریت داده‌های نمایشی برای تست و نمایش. داده‌های نمونه را بارگذاری یا حذف کنید.",
      ...
      clearConfirm:
        "آیا مطمئنید که می‌خواهید تمام داده‌های نمایشی را حذف کنید؟ این عمل قابل بازگشت نیست.",
    ...
    recentOrders: "سفارش‌های اخیر",
    recentTickets: "تیکت‌های اخیر",
    recentLeads: "سرنخ‌های اخیر",
  },

  leads: {
    title: "مدیریت سرنخ‌های بیمه",
    details: "جزئیات سرنخ",
    backToLeads: "بازگشت به سرنخ‌ها",
    fullName: "نام و نام خانوادگی",
    phoneNumber: "شماره تماس",
    city: "شهر",
    preferredContactTime: "زمان تماس",
    notes: "توضیحات",
